...
public class CalendarReader2
{
    ...
    public static void readCalendar(Context context) {
        ...
        cursor = contentResolver.query(CalendarHelper.CALENDAR_URI, CalendarHelper.FIELDS, null, null, null);
        HashSet<String> calendarIds = new HashSet<String>();
        calendarIds  = (HashSet<String>) CalendarHelper.getCalendarsIDs();
                ...
                /* the calendar control metting-begin events Respose  sub-string (starts....hare) */
                    ...
                    /* the calendar control metting-end events Respose  sub-string (starts....hare) */
                      ...
                      /* the calendar control metting-end events Respose  sub-string (starts....ends) */
                        ...
                        Log.e("BEGIN DATE", beg_date.toString());
    ...
    public static long getNewEventId(ContentResolver cr, Uri cal_uri)
    {
        ...
        Log.e("TITLE OF EVENT",""+max_val+1);
        return max_val + 1;
    }

    public static void getEventName(ContentResolver cr, Uri cal_uri)
    {
        Uri local_uri = cal_uri;
        if (cal_uri == null)
        {
        ...
        Cursor cursor = cr.query(local_uri, new String[]{"title"}, null, null, "_id");
        cursor.moveToFirst();
        while (cursor.moveToNext()) {
            String title = cursor.getString(0);
            Log.e("TITLE OF EVENT",title);
        }

    }

    public static void getEventsOfToday(ContentResolver cr, Uri cal_uri) {
        Uri local_uri = cal_uri;
        if (cal_uri == null) {
            local_uri = Uri.parse("content://com.android.calendar/events");
        }
